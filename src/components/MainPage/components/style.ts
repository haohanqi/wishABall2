...
import { BasicSection, LargeTitle, MediumTitle, SmallTitle, SmallText, BasicColor } from '../../BasicStyle';
...
export const ImageItem = styled.div<ImageItemProps>`
  ...
  @media only screen and (max-width:480px){
    ...
    grid-column: ${props => props.mobileStartCol} / ${props => props.mobileEndCol};
    grid-row: ${props => props.mobileStartRow} / ${props => props.mobileEndRow};
  }
`
