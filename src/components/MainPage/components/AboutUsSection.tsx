...
import { AboutUsWrapper, AboutUsTitleWrapper, AboutUsContentWrapper, ImageItem } from './style'
...
const AboutUsSection = () => {
	...
	const WorkWithUsItem: FC<WorkWithUsItemProps>= ({title,des,children})=>{
		return (
						...
						<div className="aboutUsIntroImageWrapper">
							<ImageItem 
								...
								<div className="imageContentWrapper">	
									...
									<p className="imageCoverDes">ake a type specimen book. It has survived not only five centuries, but also the leap into electronic </p>
								</div>
							</ImageItem>
							<ImageItem 
								startRow={'2'} 
						...
						<div className="workWithUsWrapper">
							<Row justify='space-between' align='middle'>
								<Col xl={5} lg={5} md={12} sm={12} xs={11}>
									<WorkWithUsItem title="Job Opportunity" des="This is a short description">
										{
											<BiSearchAlt2/>
										}
									</WorkWithUsItem>
								...
								<Col xl={5} lg={5} md={12} sm={12} xs={11}>
									<WorkWithUsItem title="Partnership" des="This is a short description">
										{
											<FaHandshake />
										}
									</WorkWithUsItem>
								...
								<Col xl={5} lg={5} md={12} sm={12} xs={11}>
									<WorkWithUsItem title="Ad & Sponsorship" des="This is a short description">
										{
											<RiTeamFill/>
										}
									</WorkWithUsItem>
								...
								<Col xl={5} lg={5} md={12} sm={12} xs={11}>
									<WorkWithUsItem title="Contact Us" des="This is a short description">
										{
											<RiUserSearchFill />
										}
									</WorkWithUsItem>
