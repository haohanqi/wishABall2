...
import { WishSectionWrapper, WishInfoWrapper, WishImgWrapper, WishButtonWrapper, PromoBox } from './style'
			...
			<Row justify='space-around' align='middle' style={{minHeight:'100vh'}}>
				<Col xl={5} lg={5} md={5} sm={22} xs={22}>
					<WishInfoWrapper>
						...
						<SocialMediaGroup imgs={[wechat, ins, facebook]} mobileHidden={true}/>
				...
				<Col xl={5} lg={5} md={5} sm={24} xs={24}>
					<WishImgWrapper>
						...
						<div className='promoRow'>
							<PromoBox backgroundImage={wish3} width='48%' height='100%' small={true} >
								<div className='promoTitle'>Hockey</div>
								<div className='promoDes'>This is a promation</div>
							</PromoBox>
							<PromoBox backgroundImage={wish2} width='48%' height='100%' small={true} >
