...
const news = [
	{
		...
		"date":"2020 03 25",
		"blogDes": "Winter Kids Basketball Training will happen in this winter happen in this winterhappen in this winter ds Basketball Training ..."
	},
	{
...
const index = () => {
	return (
		<>
			<NewsSection/>
			<AdverSection/>
			<MoreNewsSection type="news" data={news}/>
			<MoreNewsSection type="event" data={event} />
		</>
	)
}
