...
import { HeaderWrapper, NavBar, LanguageTransButton, MobileNavMenuWrapper } from './style';
      ...
      >
        <Row justify="start" align="middle">
          ...
          <Col xl={21} lg={21} md={21} sm={0} xs={0}>
            <div className="hbar" style={{ width: '100%', height: '20px', backgroundColor:'#F1F1F1'}}>
            </div>
          </Col>

          {/* mobile version */}
          <Col xl={0} lg={0} md={0} sm={{ span: 15, offset: 1 }} xs={{ span: 15, offset: 2 }}>
            <div className="mobileNavBarWrapper">
              <LanguageTransButton mobileHidden={false} >中文</LanguageTransButton>
              <GiHamburgerMenu className="navHamIcon" onClick={showMobileNavMenu}/>
            </div>
          </Col>
          {/* mobile version */}
        </Row>
        ...
        {/* desktop version */}
        <Row>
          <Col xl={{ span: 14, offset: 8 }} lg={{ span: 12, offset: 12 }} md={{ span: 12, offset: 8 }} sm={0} xs={0}>
            <NavBar>
...
const MobileNavMenu  = ()=>{
  ...
  return (
    <MobileNavMenuWrapper className="MobileNavMenuWrapper">
        <AiOutlineClose className="mobileCloseButton" onClick={closeMobileNavMenu}/>
        <div className="mobileNavBar">
          ...
          <SocialMediaGroup imgs={[insIcon, wechatIcon, facebookIcon]} width="80%"/>
        </div>
